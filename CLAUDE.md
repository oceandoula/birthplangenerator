...
- `xlateAnswer()`：已存答案自動翻成目前語言（文字版+視覺版都套用；
  **選項數不一致的題目有安全鎖不翻譯**，見待辦）
- AI 文字計畫書（模板生成，免費）
...
## 待辦事項
- [ ] **對齊中英文選項清單**（7 題數量不一致，xlateAnswer 對這些題不翻譯：
      vbac 4/3、coping 13/11、push_pref 7/8、delivery_pref 12/9、
      skin_to_skin 4/3、placenta 5/3、newborn_proc 10/8——要逐題補translated選項）
